...
const HomePage = () => {
  // Outlet context থেকে activeCategory, shop তথ্য এবং মডাল ওপেন করার ফাংশন রিসিভ করা
  ...
  // Search state এবং view mode state ('grid' or 'list')
  const [searchQuery, setSearchQuery] = useState('');
  const [viewMode, setViewMode] = useState('grid');

  // ডায়নামিক ক্যাটাগরি লিস্ট থেকে বর্তমান সিলেক্টেড ক্যাটাগরিটি খুঁজে বের করা
